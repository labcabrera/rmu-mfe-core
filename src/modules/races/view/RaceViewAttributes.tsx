...
const RaceViewAttributes: FC<{
  ...
  return (
    <Grid container spacing={2}>
      <Grid size={4}>
        <TextField label={t('name')} variant="standard" name="name" value={race.name} fullWidth />
      </Grid>
      <Grid size={12}></Grid>
      <Grid size={2}>
      ...
      <Grid size={12}></Grid>
      <Grid size={4}>
        <TextField label={t('default-language')} variant="standard" name="defaultLanguage" value={race.defaultLanguage} required fullWidth />
      </Grid>
      <Grid size={12}></Grid>
      <Grid size={2}>
